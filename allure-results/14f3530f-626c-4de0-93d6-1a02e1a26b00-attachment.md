...
- Name: TC 02: Login with Invalid Username
...
Call log:
  - navigating to "https://127.0.0.1/#/login", waiting until "load"
    ...
    at D:\Playwright\tests\oddbit.spec.ts:39:14
```
...
>  39 |   await page.goto('https://127.0.0.1/#/login');
  ...
  107 |   await newPage2.waitForTimeout(2000);
  108 |
  109 |   // save screenshot
  110 |   const screenshot4 = await newPage2.screenshot()
  111 |   test.info().attach('Check_Youtube_Link', {contentType: 'image/png', body: screenshot4});
  112 |   
  113 | })
```