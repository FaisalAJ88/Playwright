...
Call log:
  - navigating to "https://10.16.115.168/#/login", waiting until "load"
...
```yaml
- 'heading "Warning: Potential Security Risk Ahead" [level=1]'
- paragraph: Nightly detected a potential security threat and did not continue to 10.16.115.168. If you visit this site, attackers could try to steal information like your passwords, emails, or credit card details.
- paragraph
- paragraph:
  - link "Learn more…":
    - /url: https://support.mozilla.org/1/firefox/137.0/WINNT/en-US/connection-not-secure
- button "Go Back (Recommended)"
- button "Advanced…"
```
